...
export const metadata: Metadata = {
  title: "DuckBar - Authentic Ukrainian Restaurant & Bar",
  description: "Experience authentic Ukrainian cuisine, premium vodka, and warm hospitality at DuckBar. Traditional food, live music, and perfect for events.",
  keywords: "Ukrainian restaurant, vodka bar, Ukrainian food, authentic cuisine, restaurant downtown",
  metadataBase: new URL("https://duckbar.example.com"),
  alternates: {
    canonical: "https://duckbar.example.com"
  },
  openGraph: {
    title: "DuckBar - Authentic Ukrainian Experience",
    description: "Discover traditional Ukrainian cuisine and premium vodka at DuckBar. Perfect for dining and events.",
    siteName: "DuckBar",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764144337795-nti38xvu.jpg",
      alt: "DuckBar Ukrainian restaurant interior"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "DuckBar - Ukrainian Restaurant",
    description: "Authentic Ukrainian food, vodka, and hospitality",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764144337795-nti38xvu.jpg"]
  },
  robots: {
    index: true,
    follow: true
